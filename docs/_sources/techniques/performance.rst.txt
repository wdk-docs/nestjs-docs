...
Under the hood, Nest makes use of `Express <https://expressjs.com/>`__,
...
A `Fastify <https://github.com/fastify/fastify>`_ fits here very well
...
But we don’t lock people in a single paradigm. We let them use whatever
...
helps to integrate this library with Nest.
...
If you’re running your Nest instance inside of a **docker container**
you will need to specify the host, like so:

.. code:: typescript

   await app.listen(3000, '0.0.0.0');

And that’s all. Also, you are able to pass options into fastify
...
`here <https://github.com/nestjs/nest/tree/master/sample/10-fastify>`__.
