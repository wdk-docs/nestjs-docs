...
The `MQTT <http://mqtt.org/>`_ is a lightweight messaging protocol,
...
In order to switch to **MQTT** transporter, we need to modify an options
...
`here <https://github.com/mqttjs/MQTT.js>`__.
