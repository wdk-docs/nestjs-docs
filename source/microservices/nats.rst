...
The `NATS <https://nats.io>`_ is a simple, high performance open source
messaging system.
...
In order to switch to **NATS** transporter, we need to modify an options
...
``undefined`` if you don’t want use any particular queue)
